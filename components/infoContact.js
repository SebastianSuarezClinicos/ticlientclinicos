...
// component
export const ModalInfoContact = ({ setModalInfoContact }) => {
  const cerrarModal = () => {
        ...
        <div className="flex flex-col items-center justify-center rounded-lg shadow-lg bg-white">
          <div className="p-4 text-lg font-semibold text-black">
            ...
            <div className="py-4 border-b-2">
              <div>Teléfono: 4926811 opción 0</div>
              <div>Whatsapp: +56 3168327539</div>
              <div>
                Correo: atencion.socupacional@clinicos.com.co
                saludocupacional.ecopetrol@clinicos.com.co
              </div>
              <div>
                Dirección- PAMI San Martín: Carrera 21 # 36 40 Local: 131
              </div>
            </div>
          </div>
        </div>
